...
![logo](./docs/images/logo.png =300px)
...
* Implementation:  
![Implementation-Implementation](docs/images/KNN.png=600x)
  
* Sk-learn library:  
  ![KNN Library](docs/images/KNN_lib.png=600x)
...
* Implementation:  
    ![Naive Bayes implementation](docs/images/NB.png=600x)
