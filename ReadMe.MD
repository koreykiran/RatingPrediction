...
![logo](docs/images/logo.png?raw=true=300x)
...
Since the feature we used is just bag-of-words the accuracy of the models is not high, if other features like word embedding with context window and TF-IDF are used the accuracy of the model can be increased.
...
* Implementation:  
![Implementation-Implementation](docs/images/KNN.png?raw=true=600x)
  
* Sk-learn library:  
  ![KNN Library](docs/images/KNN_lib.png?raw=true=600x)
...
* Implementation:  
    ![Naive Bayes implementation](docs/images/NB.png?raw=true=600x)
  
* Sk-learn library:  
![Naive Bayes Library](docs/images/NBLib.png=600x)
